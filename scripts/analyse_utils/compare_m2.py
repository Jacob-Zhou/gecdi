...
def simplify_edits(sent):
    ...
    edits = [edit for edit in sent.split("\n") if edit.startswith("A ")]
    ...
    for hyp_id in hyp_dict.keys():
        for ref_id in ref_dict.keys():
            ...
            if args.verbose:
                ...
                output_sentence = get_cor_and_edits(original_sentence, hyp_verb)
                gold_sentence = get_cor_and_edits(original_sentence, ref_verb)
                print("HYPOTHESIS EDITS :", hyp_verb)
                print("HYPOTHESIS SENT  : " + output_sentence)
                print("REFERENCE EDITS  :", ref_verb)
                print("REFERENCE SENT   : " + gold_sentence)
